...
class AppPreferences
    ...
    constructor(
        ...
        val playerSeekBackIncrement get() =
            sharedPreferences
                .getString(
        ...
        val playerSeekForwardIncrement get() =
            sharedPreferences
                .getString(
        ...
        val playerMpvHwdec get() = sharedPreferences.getString(Constants.PREF_PLAYER_MPV_HWDEC, "auto")!!
        ...
        // Downloads
        val downloadOverMobileData get() =
            sharedPreferences.getBoolean(
                Constants.PREF_DOWNLOADS_MOBILE_DATA,
                false,
            )
        val downloadWhenRoaming get() =
            sharedPreferences.getBoolean(
